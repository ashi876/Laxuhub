...
关于更新说明:20260208
	...
	win环境三十年来依靠环境变量管理的方式从没有改变，未来十年也看不到改变的可能.
	所以本主程序如无重大bug，基本不会更新，保证主程序的长久一致性。
	发布一体包只是为了展示主程序的功能。环境中的任何一项语言或工具可以自行更新或添加。
	如无必要，基本不会更新，当然也考虑一年一次更新相关语言环境，为了初用环境的新人。
